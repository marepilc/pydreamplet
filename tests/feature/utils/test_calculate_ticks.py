...
def test_ticks_are_properly_rounded():
    ...
    assert ticks == [0, 10000, 20000, 30000, 40000, 50000]
    ticks = calculate_ticks(0, 87654, 5)
    assert ticks == [0, 20000, 40000, 60000, 80000, 100000]
    ticks = calculate_ticks(0, 157000, 5)
...
def test_num_ticks_works():
    ticks = calculate_ticks(0, 42986, 3, below_max=True)
